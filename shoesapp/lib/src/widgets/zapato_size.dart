    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          height: (this.fullScreen) ? 390 : 430,
...
class _ZapatoConSombre extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final zapatoModal = Provider.of<ZapatoModel>(context);
    return Padding(
      padding: const EdgeInsets.all(50),
      child: Stack(
        children: <Widget>[
          Positioned(bottom: 20, right: 0, child: _zapatoSombra()),
          Image(image: AssetImage(zapatoModal.assetsImage))
        ],
      ),
    );
  }
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: Color(0xffEAA14E), blurRadius: 30)]),
      ),
    );
  }
}
